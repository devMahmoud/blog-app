...
second_post = Post.create(author: first_user, title: 'Hello 2', text: 'This is my 2nd post', comments_counter: 0, likes_counter: 0)
third_post = Post.create(author: first_user, title: 'Hello 3', text: 'This is my 3rd post', comments_counter: 0, likes_counter: 0)
fourth_post = Post.create(author: first_user, title: 'Hello 4', text: 'This is my 4th post', comments_counter: 0, likes_counter: 0)
fifth_post = Post.create(author: second_user, title: 'Hello 5', text: 'This is my first post', comments_counter: 0, likes_counter: 0)

Comment.create(post: first_post, author: second_user, text: 'Hi Tom!' )
Comment.create(post: first_post, author: second_user, text: 'Nice to meet you.' )
Comment.create(post: first_post, author: second_user, text: 'How are you.' )
Comment.create(post: first_post, author: second_user, text: 'I hope you are doing well.' )
Comment.create(post: first_post, author: second_user, text: 'Nice post' )
Comment.create(post: first_post, author: second_user, text: 'I like it' )
